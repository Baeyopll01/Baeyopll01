...
function Library:CreateWindow(info)
	...
	do
		...
		resize.TouchTap:Connect(function()
			R = true
		end)
		...
		U.InputChanged:Connect(function(i)
			if R and (i.UserInputType == Enum.UserInputType.MouseMovement or i.UserInputType == Enum.UserInputType.Touch) then
				local nW = math.max(480, i.Position.X - Background_1.AbsolutePosition.X)
				local nH = math.max(350, i.Position.Y - Background_1.AbsolutePosition.Y)
