...
local themes = {
    ...
    Exspace = {
        ...
        ['Page'] = Color3.fromRGB(18, 18, 28),
        ['Main'] = Color3.fromRGB(30, 30, 40),
        ['Text & Icon'] = Color3.fromRGB(180, 200, 255),
        ['Function'] = {
            ['Toggle'] = {
                ['Background'] = Color3.fromRGB(20, 20, 30),
                ['True'] = {
                    ['Toggle Background'] = Color3.fromRGB(30, 30, 40),
                    ['Toggle Value'] = Color3.fromRGB(100, 160, 255), -- ฟ้า
                },
                ['False'] = {
                    ['Toggle Background'] = Color3.fromRGB(25, 25, 35),
                    ['Toggle Value'] = Color3.fromRGB(50, 60, 80),
                }
            },
            ['Label'] = {
                ['Background'] = Color3.fromRGB(20, 20, 30),
            ...
            ['Dropdown'] = {
                ...
                ['Value Stroke'] = Color3.fromRGB(180, 200, 255),
                ['Dropdown Select'] = {
                    ['Background'] = Color3.fromRGB(15, 15, 25),
            ...
            ['Slider'] = {
                ...
                ['Value Background'] = Color3.fromRGB(15, 15, 25),
                ['Value Stroke'] = Color3.fromRGB(180, 200, 255),
                ['Slider Bar'] = Color3.fromRGB(30, 30, 40),
            ...
            ['Code'] = {
                ...
                ['Background Code Value'] = Color3.fromRGB(22, 22, 32),
                ['ScrollingFrame Code'] = Color3.fromRGB(180, 180, 230)
            },
            ['Button'] = {
                ['Background'] = Color3.fromRGB(20, 20, 30),
                ['Click'] = Color3.fromRGB(180, 200, 255)
            },
            ['Textbox'] = {
                ['Background'] = Color3.fromRGB(20, 20, 30),
                ['Value Background'] = Color3.fromRGB(15, 15, 25),
            ...
            ['Keybind'] = {
                ...
                ['True'] = {
                    ['Toggle Background'] = Color3.fromRGB(30, 30, 40),
                    ['Toggle Value'] = Color3.fromRGB(100, 160, 255),
                },
                ['False'] = {
                    ['Toggle Background'] = Color3.fromRGB(25, 25, 35),
                    ['Toggle Value'] = Color3.fromRGB(50, 60, 80),
            ...
            ['Color Picker'] = {
                ...
                ['Color Select'] = {
                    ['Background'] = Color3.fromRGB(15, 15, 25),
                    ['UIStroke'] = Color3.fromRGB(180, 200, 255),
                }
            }
        }
    },
