...
local b, c = {
        ...
        IsMobile = false,
        Fonts = {Inter = Font.new("rbxasset://fonts/families/FredokaOne.json", Enum.FontWeight.Medium, Enum.FontStyle.Normal)},
        Storage = {
            Background = {},
            BackgroundGradient = {},
            Notification = {},
...
function b:Window(t)
    ...
    function b:Notify(t)
        ...
        aG.Name = "NotifyTitle"
        aG.FontFace = b.Settings.FontFace or Font.new("rbxasset://fonts/families/FredokaOne.json")
        aG.RichText = true
        aG.Text = "NEXT"
        ...
        aL.Name = "ContentText"
        aL.FontFace = b.Settings.FontFace or Font.new("rbxasset://fonts/families/FredokaOne.json")
        aL.Text = an.Content
        ...
        aM.Name = "SubContent"
        aM.FontFace = b.Settings.FontFace or Font.new("rbxasset://fonts/families/FredokaOne.json")
    ...
    local bd =
        ...
        "TextLabel",
        {
            ...
            BackgroundColor3 = Color3.fromRGB(255, 255, 255),
            FontFace = b.Settings.FontFace or
                Font.new("rbxasset://fonts/families/FredokaOne.json", Enum.FontWeight.SemiBold, Enum.FontStyle.Normal),
            TextSize = 28,
    ...
    function am:AddTab(t)
        ...
        function am:Dialog(t)
            ...
            by.FontFace = b.Settings.FontFace or Font.new("rbxasset://fonts/families/FredokaOne.json")
            by.Text = an.Content
            ...
            for q, r in pairs(an.Buttons) do
                ...
                bE.Name = "DialogTitle"
                bE.FontFace = b.Settings.FontFace or Font.new("rbxasset://fonts/families/FredokaOne.json")
                bE.Text = r.Title
        ...
        function bi:AddDropdown(t)
            ...
            local ce =
                ...
                {
                    Name = "TextLabel",
                    FontFace = b.Settings.FontFace or Font.new("rbxasset://fonts/families/FredokaOne.json"),
                    Text = cd,
                    TextColor3 = Color3.fromRGB(240, 240, 240),
                    TextSize = 13,
